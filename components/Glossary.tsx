    ...
    <div className="min-h-screen bg-brand-black pt-32 pb-20">
      <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="text-center mb-16">
            ...
            <div className="relative max-w-lg mx-auto">
              <input 
                ...
                className="w-full bg-zinc-900 border border-zinc-700 rounded-full py-4 pl-12 pr-4 text-white focus:outline-none focus:border-brand-green transition-colors"
                value={searchTerm}
          ...
          {filteredTerms.length > 0 ? (
            filteredTerms.map((item, idx) => (
              <Reveal key={idx} delay={idx * 50}>
                <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl hover:border-brand-green/30 transition-all group">
        ...
        <div className="mt-20 bg-brand-green/5 border border-brand-green/20 rounded-2xl p-8 text-center">
          ...
          <p className="text-zinc-400 mb-8 max-w-lg mx-auto">Our team is happy to explain any technical details in plain English over the phone.</p>
