  ...
  return (
    <div className="min-h-screen bg-brand-black pt-32 pb-20">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        {/* 0% VAT Section */}
        <Reveal delay={100}>
          <div className="mb-16 bg-zinc-900 border border-zinc-800 rounded-3xl overflow-hidden shadow-2xl">
        ...
        <Reveal delay={200}>
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-white mb-6 flex items-center gap-3">
              <div className="p-2 bg-zinc-800 rounded-lg text-brand-green"><PoundSterling size={24} /></div>
        ...
        <Reveal delay={300}>
          <div className="mb-16">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8">
              ...
              <ul className="list-disc pl-5 space-y-2 text-zinc-400 mb-8">
