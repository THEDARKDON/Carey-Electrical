...
export const LOCATIONS: LocationItem[] = [
  ...
  { name: 'Slough', slug: 'slough', county: 'Berkshire', lat: 51.5105, lng: -0.5950 },
  { name: 'High Wycombe', slug: 'high-wycombe', county: 'Buckinghamshire', lat: 51.6288, lng: -0.7482 },
  { name: 'Henley-on-Thames', slug: 'henley-on-thames', county: 'Oxfordshire', lat: 51.5362, lng: -0.9027 },
  { name: 'Wallingford', slug: 'wallingford', county: 'Oxfordshire', lat: 51.5996, lng: -1.1255 },
  { name: 'Caversham', slug: 'caversham', county: 'Berkshire', lat: 51.4701, lng: -0.9731 },
  { name: 'Tilehurst', slug: 'tilehurst', county: 'Berkshire', lat: 51.4609, lng: -1.0375 },
  { name: 'Woodley', slug: 'woodley', county: 'Berkshire', lat: 51.4536, lng: -0.9006 },
  { name: 'Earley', slug: 'earley', county: 'Berkshire', lat: 51.4367, lng: -0.9314 },
  { name: 'Sandhurst', slug: 'sandhurst', county: 'Berkshire', lat: 51.3478, lng: -0.7969 },
  { name: 'Crowthorne', slug: 'crowthorne', county: 'Berkshire', lat: 51.3708, lng: -0.7926 },
  { name: 'Lambourn', slug: 'lambourn', county: 'Berkshire', lat: 51.5142, lng: -1.5378 },
  { name: 'Pangbourne', slug: 'pangbourne', county: 'Berkshire', lat: 51.4855, lng: -1.0845 },
  { name: 'Tadley', slug: 'tadley', county: 'Hampshire', lat: 51.3482, lng: -1.1304 },
  { name: 'Whitchurch', slug: 'whitchurch', county: 'Hampshire', lat: 51.2329, lng: -1.3396 },
  { name: 'Overton', slug: 'overton', county: 'Hampshire', lat: 51.2426, lng: -1.2607 },
  { name: 'Kingsclere', slug: 'kingsclere', county: 'Hampshire', lat: 51.3249, lng: -1.2368 },
  { name: 'Burghfield', slug: 'burghfield', county: 'Berkshire', lat: 51.4126, lng: -1.0458 },
  { name: 'Mortimer', slug: 'mortimer', county: 'Berkshire', lat: 51.3735, lng: -1.0561 },
  { name: 'Aldermaston', slug: 'aldermaston', county: 'Berkshire', lat: 51.3892, lng: -1.1354 },
  { name: 'Theale', slug: 'theale', county: 'Berkshire', lat: 51.4321, lng: -1.0758 },
  { name: 'Calcot', slug: 'calcot', county: 'Berkshire', lat: 51.4338, lng: -1.0378 },
  { name: 'Purley on Thames', slug: 'purley-on-thames', county: 'Berkshire', lat: 51.4797, lng: -1.0814 },
  { name: 'Goring', slug: 'goring', county: 'Oxfordshire', lat: 51.5244, lng: -1.1413 },
  { name: 'Streatley', slug: 'streatley', county: 'Berkshire', lat: 51.5269, lng: -1.1393 },
  { name: 'Hermitage', slug: 'hermitage', county: 'Berkshire', lat: 51.4741, lng: -1.2868 },
  { name: 'Cold Ash', slug: 'cold-ash', county: 'Berkshire', lat: 51.4364, lng: -1.2837 },
  { name: 'Chieveley', slug: 'chieveley', county: 'Berkshire', lat: 51.4556, lng: -1.3133 },
  { name: 'Compton', slug: 'compton', county: 'Berkshire', lat: 51.5116, lng: -1.3034 },
  { name: 'East Ilsley', slug: 'east-ilsley', county: 'Berkshire', lat: 51.5195, lng: -1.3399 }
];
